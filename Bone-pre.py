...
with col1:
    conf_threshold = st.slider("**Confidence Threshold**", 0.2, 1.0, 0.6, 0.01, on_change=clear())
    iou_threshold = st.slider("**IOU Threshold**", 0.0, 1.0, 0.45, 0.01, on_change=clear())
    sex = st.radio("**Sex**", ["boy", "girl"], on_change=clear())
with col2:
